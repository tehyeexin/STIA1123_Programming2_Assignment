...
public class LoginPage extends JFrame {
	...
	public LoginPage() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginPage.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		lblBakeryImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Cherry On Top Bakery.png")));
		...
		lblUsernameicon.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/icon username.png")));
		...
		lblPasswordIcon.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/icon password.png")));
		...
		lblInvisiblePassword.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Password Invisible.png")));
		lblInvisiblePassword.setBounds(487, 283, 28, 36);
		panel.add(lblInvisiblePassword);
		
		JLabel lblVisiblePassword = new JLabel("");
		lblVisiblePassword.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Password Visible.png")));
