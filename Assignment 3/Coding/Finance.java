...
public class Finance extends JFrame {
	...
	public Finance() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Finance.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		btnBack.setIcon(new ImageIcon(Finance.class.getResource("/BakeryPhotos/8 back icon honeydew.png")));
