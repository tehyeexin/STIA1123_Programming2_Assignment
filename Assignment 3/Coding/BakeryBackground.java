...
public class BakeryBackground extends JFrame {
	...
	public BakeryBackground() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(BakeryBackground.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		lblCherrylogo.setIcon(new ImageIcon(BakeryBackground.class.getResource("/BakeryPhotos/Cherry Logo 2.png")));
		...
		btnBack.setIcon(new ImageIcon(BakeryBackground.class.getResource("/BakeryPhotos/4 back icon lavenderbrush.png")));
