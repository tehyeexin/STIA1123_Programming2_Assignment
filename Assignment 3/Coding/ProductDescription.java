...
public class ProductDescription extends JFrame {
	...
	public ProductDescription() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ProductDescription.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		lbl_productImage.setIcon(new ImageIcon(ProductDescription.class.getResource("/BakeryPhotos/Cherry Logo 4.png")));
				...
				try {
					if(cmBox_category.getSelectedItem().equals("Bun")) { 
						...
						if(cmBox_product.getSelectedItem().equals("Mexican Coffee Bun")) {
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Mexico Coffee Bun.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Ham and Cheese Bun.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Red Bean Bun.png")));
						...
						if(cmBox_product.getSelectedItem().equals("Portuguese Egg Tart")) {
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Portuguese Egg Tart.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Chocolate Almond Tart.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Blueberry Cheese Tart.png")));
						...
						if(cmBox_product.getSelectedItem().equals("Hokkaido Triple Cheese Cake")) {
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Hokkaido Triple Cheese Cake.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Moist Chocolate Cake.png")));
							...
							lbl_productImage.setIcon(new ImageIcon(LoginPage.class.getResource("/BakeryPhotos/Product - Matcha Ice Cream Cake.png")));
