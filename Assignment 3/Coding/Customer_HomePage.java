...
public class Customer_HomePage extends JFrame {
	...
	public Customer_HomePage() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Customer_HomePage.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		lblCherrylogo.setIcon(new ImageIcon(Customer_HomePage.class.getResource("/BakeryPhotos/Cherry Logo 1.png")));
		...
		btnBack.setIcon(new ImageIcon(Customer_HomePage.class.getResource("/BakeryPhotos/2 back icon mistyrose.png")));
