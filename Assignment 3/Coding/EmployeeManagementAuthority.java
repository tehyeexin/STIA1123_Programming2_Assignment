...
public class EmployeeManagementAuthority extends JFrame {
	...
	public EmployeeManagementAuthority() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(EmployeeManagementAuthority.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		btnBack.setIcon(new ImageIcon(EmployeeManagementAuthority.class.getResource("/BakeryPhotos/7 back icon floralwhite.png")));
