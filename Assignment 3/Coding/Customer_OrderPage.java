...
public class Customer_OrderPage extends JFrame {
	...
	public Customer_OrderPage() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Customer_OrderPage.class.getResource("/BakeryPhotos/Cherry Icon.png")));
		...
		btnBack.setIcon(new ImageIcon(Customer_OrderPage.class.getResource("/BakeryPhotos/1 back icon seashell.png")));
				...
				try {
					if(cmBox_category.getSelectedItem().equals("Select...") || cmBox_product.getSelectedItem().equals("Select...")) {
						...
						if(subtotal < 30) {
							...
							double orderTotal = subtotal * (1 - discount);
							textField_orderTotal.setText(String.format("%.2f", orderTotal));
						}
						else {
